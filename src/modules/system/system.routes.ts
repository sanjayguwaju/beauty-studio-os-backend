...
import { getRedisStats, clearRedisCache, getTenants, updateTenantStatus, getTenantBranding, updateTenantSettings, updateTenant, deleteTenant, signupTenant, impersonateTenant } from "./system.controller";
...
// Phase 10: Public Signup Route
router.post("/signup", signupTenant);

router.use(authenticate);

// Authenticated route for municipality admins to update their own branding
