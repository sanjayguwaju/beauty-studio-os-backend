...
export async function seedRoles(municipality: IMunicipality) {
  ...
  const roles = [
    {
      ...
      nameNp: 'सुपर एडमिन',
      slug: 'superadmin',
      description: 'Full access to municipality settings and data',
      isSystem: true,
      level: 1,
    ...
    },
    {
      ...
      slug: 'cao',
      description: 'The supreme administrative head of the municipality. All municipal staff and divisions report to the CAO.',
      isSystem: true,
      level: 2,
      permissions: [{ module: 'all', action: 'manage' }]
    },
    {
      ...
      description: 'The political head of their respective ward',
      isSystem: true,
      level: 3,
      permissions: [{ module: 'citizens', action: 'read' }, { module: 'sifaris', action: 'manage' }, { module: 'registrations', action: 'read' }, { module: 'approvals', action: 'manage' }]
    },
    {
      municipalityId: municipality._id,
      name: 'Ward Member',
      ...
      isSystem: true,
      level: 3,
      permissions: [{ module: 'citizens', action: 'read' }]
    },
    {
      municipalityId: municipality._id,
      name: 'Ward Secretary',
      nameNp: 'वडा सचिव',
      slug: 'ward_secretary',
      description: 'The highest-ranking civil servant stationed in the ward',
      isSystem: true,
      level: 3,
      permissions: [
        { module: 'citizens', action: 'manage' },
    ...
    },
    {
      ...
      isSystem: false,
      level: 4,
      permissions: [{ module: 'citizens', action: 'manage' }, { module: 'registrations', action: 'manage' }]
    },
    {
      municipalityId: municipality._id,
      name: 'Accountant',
    ...
    },
    {
      ...
      isSystem: false,
      level: 4,
      permissions: [{ module: 'citizens', action: 'create' }, { module: 'registrations', action: 'create' }]
    },
    {
      municipalityId: municipality._id,
      ...
      level: 4,
      permissions: [
        { module: 'citizens', action: 'create' },
        { module: 'citizens', action: 'read' },
  ...
  for (const roleData of roles) {
    const existing = await Role.findOne({ municipalityId: municipality._id, slug: roleData.slug });
    if (!existing) {
